...
{
    Task<IEnumerable<PaymentDto>> GetAllPaymentsAsync(PaymentSearchDto search);
    ...
    Task<IEnumerable<PaymentDto>> SearchPaymentsAsync(PaymentSearchDto searchCriteria);
}